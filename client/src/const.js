...
export const FOOTER_DATA = {
    phone: '+7-985-619-77-00',
    address: 'some address',
    mail: 'fm.info77@yandex.ru',
    description: ['ООО “ФИНМЭЙК” - это современный подход к ведению бухгалтерского учета, основанный на точности, скрупулёзности к деталям и профессионализме. ', 'Ваш успех - наша точность.']
}
